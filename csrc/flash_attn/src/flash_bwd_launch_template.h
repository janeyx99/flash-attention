...
// Stable-ABI: STD_CUDA_CHECK / STD_CUDA_KERNEL_LAUNCH_CHECK (versioned C shim)
// instead of c10::cuda's, so the compiled kernels carry no version-specific
// libtorch symbol dependency.
