...
// Stable-ABI: use STD_CUDA_CHECK / STD_CUDA_KERNEL_LAUNCH_CHECK (backed by the
// versioned torch_c10_cuda_check_msg C shim) instead of c10::cuda's, so the
// compiled kernels carry no version-specific libtorch symbol dependency.
